/*
    me.h -- MakeMe Configure Header for linux-x64-release
...
/* Settings */
    ...
    #define ME_DESCRIPTION "TJCTF GoAhead"
#endif
    ...
    #define ME_GOAHEAD_AUTH_STORE "custom"
#endif
...
#endif
#ifndef ME_GOAHEAD_PAM
    #define ME_GOAHEAD_PAM 0
#endif
#ifndef ME_GOAHEAD_PUT_DIR
    #define ME_GOAHEAD_PUT_DIR "."
#endif
#ifndef ME_GOAHEAD_REALM
    #define ME_GOAHEAD_REALM "TJCTF"
#endif
...
#endif
#ifndef ME_TITLE
    #define ME_TITLE "TJCTF GoAhead"
#endif
#ifndef ME_VERSION
    #define ME_VERSION "5.1.5"
#endif
...
/* Prefixes */
    ...
    #define ME_VAPP_PREFIX "/usr/local/lib/goahead/5.1.5"
#endif
    ...
    #define ME_SRC_PREFIX "goahead-5.1.5"
#endif
...
/* Profile */
    ...
    #define ME_CONFIG_CMD "me configure --release --static --set goahead.accessLog=false --set goahead.authStore=custom --set goahead.cgi=false --set goahead.javascript=false --set goahead.legacy=false --set goahead.logging=true --set goahead.pam=false --set goahead.realm=TJCTF --set goahead.upload=false --set rom=false --without mbedtls --without ssl --set author=TJCSC --set company=tjcsc --set description=TJCTF GoAhead --set title=TJCTF GoAhead"
#endif
#ifndef ME_GOAHEAD_PRODUCT
    #define ME_GOAHEAD_PRODUCT 1
#endif
#ifndef ME_PROFILE
    #define ME_PROFILE "release"
#endif
#ifndef ME_TUNE_SIZE
